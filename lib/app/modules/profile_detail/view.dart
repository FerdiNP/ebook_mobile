...
import '../../controller/auth_controller/audio_controller.dart';

class TestView extends GetView<AudioController> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Obx(() {
              return Text(
                '${_formatDuration(controller.position.value)} / ${_formatDuration(controller.duration.value)}', style: TextStyle(color: Colors.white),
              );
            }),
